...
```text
ในตอนแรกผมแบล๊งก์มากเลยว่าต้องใช้คำสั่งอะไรยังไงต่อเลยให้Aiช่วยไกด์ให้เลยรู้ว่าต้องใช้for loop
```
...
```text
ช่วยสังเกตว่า ถ้าโจทย์ถามหาในช่วงพวกนี้ใช้ for loopง่ายสุด และช่วยสังเกตเรื่องcount = 0ด้วยเพราะตอนแรกผมลืมกำหนด
...
```text
ผมตรวจสอบเรื่อง B+1 ในวงเล็บfor loopเพราะ เวลาจะจบถ้าไม่อยากให้จบตัวที่ต้องการเราต้องบวกไป1เพราะปกติมันจะจบที่ตัวเลขก่อนหน้า
```
...
```text
ได้เรียนรู้ว่าอย่าลืมกำหนดcount = 0ด้วย
ได้เรียนรู้ว่า เวลาหาในช่วงแบบนี้ใช้for loopคิดง่ายสุด
```
