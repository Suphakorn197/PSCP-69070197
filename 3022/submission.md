...
```text
Input:
รับค่าอุณหภูมิและหน่วยC,F,K,Rเข้ามาเป็นจำนวนจริง
Output:
เป็นอุณหภูมิที่เป็นจำนวนจริงและทศนิยม2ตำแหน่ง
Constraints:
inputที่รับเข้ามาต้องเป็นจำนวนจริงเลยต้องใช้float
```
...
```text
Step 1: รับค่าอุณหภูมิเข้ามาเป็นจำนวนจริง
Step 2: รับค่าหน่วยของอุณหภูมิ พวก C,F,K,R
Step 3: รับค่าอักษร C, F, K, R เป็นหน่วยของอุหณภูมิที่ต้องการ
Step 4:กำหนดC,ans = 0
Step5:เข้าเงื่อนไขif elif  แล้วเขียนสมการหาC
Step6:ใช้เงื่อนไขifอีกรอบเพื่อที่จะหาans
...
```text
วิธีสุดท้ายเหมือนกับแผนแรกเลย คือรับค่าอุณหภูมิเข้ามาเป็นจำนวนจริงและรับค่าหน่วยของอุณภูมิกับอักษร C, F, K, R หน่วยของอุหณภูมิจากนั้นก็กำหนดให้ในตอนแรกC,ans=0 แล้วก็ใช้if,elifเพื่อสร้างสมการหาC และใช้ifอีกรอบเพื่อหาans
```
...
```text
เพื่อที่จะได้รู้ว่าถ้าเราใช้floatจะได้outputออกมาเป็นจำนวนจริงมั้ย
```
...
```text
เพื่อทดสอบว่าโปรแกรมสามารถรับค่าตัวเลขติดลบได้ถูกต้องมั้ยเพราะอุณหภูมิ-40°C จะมีค่าเท่ากับ-40°Fพอดีเป๊ะ
```
...
```text
เพื่อทดสอบเส้นทางการแปลงหน่วยอื่นกลับมาเป็นเซลเซียส ซึ่งเคสนี้จะช่วยให้เราจับบั๊กในโค้ดปัจจุบันที่ลืมเขียนเงื่อนไ elif unit == "C": ไว้ในส่วนท้ายของโปรแกรมได้
```
