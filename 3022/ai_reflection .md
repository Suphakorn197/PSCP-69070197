...
```text
ให้ช่วยตอนใช้เงื่อนไขif elif ในการหาansและCครับในตอนแรกผมจะเขียนสมการตามในโจทย์เลยแต่ก็คิดว่าไม่ใช่เลยลองถามแชท แชทเลยบอกว่าต้องย้ายสมการให้เหลือCตัวเดียวก่อนเพราะเราต้องการหาCอยู๋แล้ว
```
...
```text
ช่วยสังเกตเรื่องการย้ายสมการ แบบเราจะเอาสมการจากโจทย์มาคิดเลยไม่ได้เราต้องมีการย้ายข้างสมการตามที่โจทย์ต้องการด้วย
```
...
```text
ผมตรวจสอบเรื่องการเขียนf-string ทศนิยม2ตำแหน่ง และ การหาansเองครับ
```
...
```text
เรียนรู้ว่าเวลาทำโจทย์คิดเลขจะต้องมีการย้ายข้างสมการด้วย
เรียนรู้ว่าต้องเขียนf-stringตลอดเวลาที่โจทย์สั่งให้มีทศนิยม2ตำแหน่ง
```
