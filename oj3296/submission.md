...
```text
Input:
รับค่าสีที่1 R,G,Bเป็นจำนวนเต็ม โดยใช้ mapและ.split()
รับค่าสีที่2R,G,Bเป็นจำนวนเต็ม โดยใช้ mapและ.split()
Output:
 ตัวเลขผลลัพธ์การผสมสี R, G, B จำนวน3ตัว โดยใช้ f-string
Constraints:
ตอนรับค่าต้องใช้map และ .split() ตอนprintต้องใช้f-string
```
...
```text
Step1:รับค่าสีที่1R,G,Bเป็นจำนวนเต็ม โดยใช้ mapและ.split()
Step2:รับค่าสีที่2 R,G,Bเป็นจำนวนเต็ม โดยใช้ mapและ.split()
Step3:คำนวณการผสมของสี R 
Step4:คำนวณการผสมของสี G
Step5:คำนวณการผสมของสี B
Step6:print f-string
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก โดยตอนแรกจะรับค่าสีที่1และสีที่2R,G,Bเป็นจำนวนเต็ม โดยใช้ mapและ.split()จากนั้นก็จะคำนวณการผสมสีของสีทั้งสามโดยการคำนวณเราจะคำนวณทีละสีโดย เอาสีที่1และ2 มาบวกกันและ //ด้วย2เราต้องใช้//เพราะต้องการปัดเศษลง จากนั้นก็printโดยใช้ f-string
```
...
```text
ทดสอบการทำงานของสมการว่าสามารถหาค่าเฉลี่ยของสองสีที่มีค่าต่างกันในระดับกลางๆได้ถูกต้อง
```
...
```text
ทดสอบว่าถ้าสีที่เป็นสีดำสนิทมาผสมกันเองโปรแกรมจะคำนวณออกมาได้0มั้ย
```
...
```text
ทดสอบว่าโปรแกรมใช้เครื่องหมาย // ถูกต้องมั้ย
```
