...
```text
ให้ช่วยดูข้อกำหนดของSCครับเพราะตอนแรกผมอ่านแล้วงง 
```
...
```text
ช่วยสังเกตเรื่องSC และ colonตรงelifเพราะตอนแรกผมลืมใส่
```
...
```text
ผมตรวจสอบเรื่องจุดทศนิยม ขั้นตอนในการคำนวณของvatและราคารวมทั้งหมด
```
...
```text
ได้เรียนรู้ว่าตอนใช้if elifห้ามลืมcolonเด็ดขาด
ได้รู้ว่าควรที่อ่านสิ่งที่โจทย์ให้ม่ให้แตกเพราะตอนนี้ใช้aiช่วยได้แต่ตอนสอบพวกนี้ต้องทำด้วยตัวเอง
