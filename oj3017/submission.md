...
```text
Input:
รับค่าอาหารกับน้ำเข้ามาเป็นจำนวนเต็ม
Output:
ผลรวมค่าอาหาร+vat+setvice charge
Constraints:
ค่า Service Charge มีข้อกำหนดว่าค่าบริการจะคิดอย่างน้อย 50 บาท แต่จะไม่เกิน 1000 บาทและผลลัพธ์สุดท้ายจะต้องแสดงผลเป็นตัวเลขทศนิยม 2 ตำแหน่ง
...
```text
Step1:รับค่าอาหารและน้ำ
Step2:คิดservice charge
Step3:คิดvat
Step4:หาผลรวมทั้งหมด

ในตอนแรกผมคิดออกว่าต้องคิดไปทีละขั้นแต่งงตรงกฏ ข้อกำหนดว่าค่าบริการจะคิดอย่างน้อย 50 บาท แต่จะไม่เกิน 1000 บาทด้วย  คือผมอ่านโจทย์ไม่แตกเลยถามแชท พอแชทอธิบายผมเลยเข้าใจครับ
...
```text
วิธีสุดท้ายที่ใช้จริงเหมือนกับแผนแรกผมคำนวณService Chargeแล้วใช้คำสั่ง if-elif เพื่อตรวจสอบเงื่อนไขหากน้อยกว่า 50 ให้ปัดเป็น 50หรือถ้าเกิน 1000 ให้ปรับเป็น 1000 จากนั้นนำค่าบริการไปบวกกับราคาอาหารเพื่อคิดVATและนำทุกอย่างมารวมกันเพื่อแสดงผลเป็นทศนิยม2ตำแหน่งครับ
```
...
```text
เพื่อทดสอบเงื่อนไขif SC < 50 ว่าถ้าSCของค่าอาหารไม่ถึง 50 บาท โปรแกรมจะปัดเศษขึ้นไปเก็บขั้นต่ำที่50บาทได้ถูกต้องมั้ย
```
...
```text
เพื่อทดสอบเงื่อนไขif SC > 1000 ว่าถ้าSCของค่าอาหารเกิน1000บาท โปรแกรมจะปัดเศษลงเก็บที่1000บาทได้ถูกต้องมั้ย
```
...
```text
เพื่อทดสอบf-string ว่าตอนinputและตอนคำนวณถ้าเป็นเลขปกติไม่มีทศนิยมoutputออกมาจะเป็นทศนิยม2ตำแหน่งมั้ย
```
