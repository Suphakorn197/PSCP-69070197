...
```text
ตอนแรกลืมไปว่าต้องมีกรณีที่วันสุดท้ายก่อนที่จะเปลี่ยนฤดูด้วย
```
...
```text
ช่วยสังเกตว่าต้องคิดหลายๆกรณีให้ออกแบบข้อนี้ที่ต้องมีกรณีที่วันสุดท้ายก่อนที่จะเปลี่ยนฤดูด้วย
```
...
```text
ตรวจสอบว่ามีกรณีไหนที่พลาดอีกหรือตกหล่นไปอีกมั้ย
...
```text
ได้เรียนรู้ว่าวันหลังต้องคิดให้ออกทุกกรณี
ได้เรียนรู้ว่าการที่พลาดไปแค่กรณีเดียวทำให้ผิดได้เลย
