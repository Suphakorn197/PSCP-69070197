...
| OJ submission ID, if submitted | 608399 |
| OJ status | Pass |
...
```text
ให้ช่วยดูเรื่องการออกจากwhile loopผมลืมไปว่าใช้break และผมลืมกำหนดcount = 0ผมกำหนดแค่current_position = 0 เพราะอ่านโจทย์ไม่เคลียร์
```
...
```text
ให้ช่วยสังเกตเรื่องต้องอ่านโจทย์ให้ละเอียดกว่านี้
```
...
```text
ตรวจสอบตอนใช้while loop ว่าต้องเขียนอะไรยังไงบ้าง แล้วก็เช็คตำแหน่ง
```
...
```text
ได้เรียนรู้ว่าต้องอ่านโจทย์ให้ละเอียดกว่านี้
ได้เรียนรู้ว่าตอนออกจากwhile loopต้องใช้break
```
