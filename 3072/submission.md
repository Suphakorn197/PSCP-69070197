...
แสดงสระที่นับได้
Constraints:
 ตัวอักษรพิมพ์เล็กและพิมพ์ใหญ่ถือว่าเป็นตัวเดียวกัน
```
...
```text
Step1:รับค่าtextเป็นstrและ ใช้.lower()
Step2:สร้างarrayเพื่อเก็บ a,e,i,o,u
Step3:สร้างfor loopโดยกำหนดให้vเป็นตัวแปรชั่วคราว
Step4:สร้างตัวแปรfoundเพื่อเก็บข้อมูล จากการนับa,e,i,o,uในarray
Step5:ใช้ifเช็คว่าfound > 0มั้ย
Step6:print
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก ผมรับค่าtextเข้ามาเป็นstrและใช้.lower() หลังจากนั้นก็สร้างarrayเพื่อเก็บ a,e,i,o,u และ สร้างfor loopโดยกำหนดให้vเป็นตัวแปรชั่วคราวแล้วสร้างตัวแปรfoundเพื่อเก็บข้อมูลจากการนับa,e,i,o,uในarrayแล้วใช้ifเช็คว่าfound > 0มั้ยแล้วก็print
```
...
```text
ตรวจสอบการทำงานของโปรแกรมว่าสามารถค้นหาและนับจำนวนสระตัวพิมพ์เล็กในคำศัพท์ทั่วไปได้ถูกต้อง
```
...
```text
ทดสอบการทำงานของคำสั่ง.lower()เพื่อยืนยันว่าโปรแกรมสามารถแปลงสระตัวพิมพ์ใหญ่ให้เป็นตัวพิมพ์เล็กและนำมานับรวมกันได้อย่างถูกต้องตามเงื่อนไขของโจทย์
```
...
```text
ทดสอบการทำงานของคำสั่งนับจำนวน ว่าสามารถนับสระตัวเดียวกันที่ปรากฏซ้ำกันหลายครั้งในหนึ่งข้อความได้อย่างถูกต้อง
```
