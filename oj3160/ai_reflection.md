...
| OJ submission ID, if submitted | 638179 |
| OJ status | Pass |
...
```text
ให้ช่วยเรื่องการดูเรื่องย่อหน้าและนิยามของจำนวนเฉพาะ
```
...
```text
ช่วยให้เห็นบัคการจัดย่อหน้าของคำสั่งifและprin ที่tเข้าไปซ้อนอยู่ในloopผิดชั้นและช่วยแก้ความเข้าใจผิดเรื่องนิยามจำนวนเฉพาะ คือตอนแรกผมเข้าใจว่าจำนวนเฉพาะคือเลขที่หารด้วย0ลงตัวและตัวมันเอง แต่จริงๆต้องเป็นหาร1และตัวมันเองลงตัว
```
...
```text
ได้แก้ไขเรื่ิองย่อหน้าของการใช้if และ for loopใหม่เองว่าย่อหน้าต้องเป็นยังไง
```
...
```text
ได้เรียนรู้ความสำคัญของการจัดย่อหน้าว่ามีผลต่อการทำงานของลูปและเงื่อนไขอย่างไรเพื่อไม่ให้โปรแกรมทำงานผิดพลาดนอกจากนี้ยังได้เข้าใจลอจิกและนิยามที่ถูกต้องในการหาจำนวนเฉพาะมากขึ้นด้วย
