...
| OJ submission ID, if submitted | 608024 |
| OJ status | Pass |
...
```text
ให้ช่วยเรื่อง ว่าต้องใช้slicingเพราะตอนแรกผมอ่านโจทย์ละแบล๊งว่าต้องทำไง และ ตอนแรกไม่รู้ว่าต้องสร้างกล่องเปล่ามาด้วยเลยถามแชท แชทเลยบอกว่าต้องสร้างไม่งั้นจะมีโอกาสเกิดการerrorได้ง่าย และไม่รู้ว่าต้องเขียน else: num_name = num 
```
...
```text
ให้ช่วยสังเกตเรื่องelseและการสร้างกล่องเปล่าขึ้นมา แล้วก็เรื่องการใช้slicingตอนแรกผมรู้แค่[::-1] แต่ไม่รู้[[:-1]
```
...
```text
เรื่องการใช้if elif และการใช้f stringตอนprint
```
...
```text
ได้เรียนรู้ว่าการที่จะเอาตัวอักษรทุกตัวยกเว้นตัวสุดท้ายต้องเขียนยังไง
ได้เรียนรู้ว่าการสร้างกล่องเปล่าไว้มีนสำคัญแค่ไหนฏ
```
