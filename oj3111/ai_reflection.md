...
| OJ submission ID, if submitted | 626943 |
| OJ status | Pass |
...
```text
ให้ช่วยดูเรื่องการใช้round half up
```
...
```text
ช่วยสังเกตเรื่องการใช้ round half upตอนแรกไม่ผ่านบางเคสเพราะติดปัญหาการใช้round half upไม่เป็นผมเลยให้แชทสอนว่าต้องใช้ยังไงมันเลยสอนเทคนิคการบวกเศษทศนิยมก็คือ + 0.000001เข้าไปก่อนใช้คำสั่ง round เพื่อบังคับให้มันปัดเศษขึ้นแบบคณิตศาสตร์ปกติครับ
```
...
```text
หลังจากที่แชทสอนการบวกเศษทศนิยมก้คือ+ 0.000001เพื่อแก้ปัญหาการปัดเศษได้ตรวจสอบและทำความเข้าใจลอจิกคณิตศาสตร์เพิ่มเติมด้วยตัวเองว่าทำไมถึงต้องใช้ทศนิยม6ตำแหน่งและได้ตรวจสอบการใช้ f-string ซ้ำอีกรอบเพื่อให้แน่ใจว่า Output จะออกมาตรงตามที่ต้องการ
```
...
```text
ได้เรียนรู้ว่าการใช้round half up ต้องใช้ยังไง คือถ้าเราไม่บวกทศนิยม 0.000001ไปคือมันไม่จำเป็นต้องเป็น6ตำแหน่งแค่ต้องหลายตำแหน่ง ถ้าเราใช้roundเฉยๆไม่มีการบวกเข้าไปเวลาที่เห็นเลข5มันจะปัดเป็นเลขคู่เลยแล้ววในทางการค้าถ้ามันปัดลงเป้นเลขคู่แม้แค่0.01บาทแต่ก็ทำให้ขาดทุนได้เลย
```
